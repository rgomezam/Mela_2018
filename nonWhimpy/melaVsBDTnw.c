...
// ZZjj_MVA
   sprintf(cuttingMVA,"nCleanedJetsPt30 > 1 && DiJetMass > 100. && Z1Mass > 60. && Z1Mass < 120. && Z2Mass > 60. && Z2Mass < 120. && ZZjj_MVA > %f",cuts[i]);
...
//Fourth: test see if you produce the same point with the mva
    ...
    double T2 = effbkgMVA2/Z;    
    double Z2 = effsigMVA2/T;
...
//mg->Draw("ALP*"); 	
  ...
  legend->AddEntry(gr4, "BDT cut-based" , "l");
  legend->Draw("same");
